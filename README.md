About python-levenshtein-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-levenshtein-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-levenshtein-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-levenshtein
# for installing globally
pixi global install python-levenshtein
```
...
It is possible to list all of the versions of `python-levenshtein` available on your platform:
...
```
pixi search python-levenshtein --channel conda-forge
```
